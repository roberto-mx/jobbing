...
Revision ID: 065060154316
Revises: 
Create Date: 2021-08-13 18:02:19.301884
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('active', 'suspended', name='status_enum'), nullable=False),
    sa.Column('created', sa.DateTime(), nullable=False),
